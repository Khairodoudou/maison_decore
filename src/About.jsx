                            ...
                            {[{
                                ...
                                <div key={index} className="flex flex-col sm:w-full md:w-1/2 relative -m-4">
                                    <div className="p-4 md:w-full w-full">
                                        <div className="h-full bg-gray-100 transition-all hover:bg-black hover:text-white dark:text-white p-8 rounded">
                                            <svg
